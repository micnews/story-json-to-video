...
module.exports = (node, styles) => {
  ...
  if (styles.borderLeft) {
    node.setBorder(yoga.EDGE_LEFT, styles.borderLeft.width);
  }

  if (styles.borderRight) {
    node.setBorder(yoga.EDGE_RIGHT, styles.borderRight.width);
  }

  if (styles.borderTop) {
    node.setBorder(yoga.EDGE_TOP, styles.borderTop.width);
  }

  if (styles.borderBottom) {
    node.setBorder(yoga.EDGE_BOTTOM, styles.borderBottom.width);
  }
